...
def get_encoder(encoding, input_dim=3, 
                multires=6, 
                degree=4,
                num_levels=16, level_dim=2, base_resolution=16, per_level_scale=1.4472692012786865, log2_hashmap_size=19, desired_resolution=2048,
                **kwargs):
    ...
    if encoding == 'None':
        ...
        output_dim = encoder.n_output_dims
        ...
        output_dim = level_dim * num_levels
